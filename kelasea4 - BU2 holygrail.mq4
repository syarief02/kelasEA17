...
void OnTick()
{
    ...
    if(IsNewBar())
    {
        ...
        {
            // Open a buy order
            ticket = OrderSend(Symbol(), OP_BUY, LotSize, Ask, 3, 0, Ask + TakeProfit * Point, "MA Crossover Buy", 0, 0, clrGreen);
        ...
        {
            // Open a sell order
            ticket = OrderSend(Symbol(), OP_SELL, LotSize, Bid, 3, 0, Bid - TakeProfit * Point, "MA Crossover Sell", 0, 0, clrRed);
